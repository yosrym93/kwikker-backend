...
VALUES
('test_user1', 'test1', 'profile.jpg', 'banner.png', 'bio', '01-01-2019', '01-01-1999'),
('test_user2', 'test2', 'profile.jpg', 'banner.png', 'bio', '01-01-2019', '01-01-1999'),
('test_user3', 'test3', 'profile.jpg', 'banner.png', 'bio', '01-01-2019', '01-01-1999');
...
('01-01-2010', 'Test user 1, first kweek', 'test_user1', null),
...
((SELECT ID FROM KWEEK WHERE USERNAME = 'test_user1' LIMIT 1), 'test_user3', 1, 5);
...
(SELECT ID FROM HASHTAG WHERE TEXT='trend' LIMIT 1), 1, 5),
...
('test_user3', (SELECT ID FROM KWEEK WHERE USERNAME = 'test_user2' LIMIT 1), '01-01-2012');

INSERT INTO REKWEEK VALUES
('test_user3', (SELECT ID FROM KWEEK WHERE USERNAME = 'test_user1' LIMIT 1), '01-01-2011'),
('test_user1', (SELECT ID FROM KWEEK WHERE USERNAME = 'test_user3' LIMIT 1), '02-01-2013');